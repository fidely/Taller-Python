...
#Taller 1 TERRENO
print("\nTALLER #1 PERIMETRO DE UN TERRENO")
print("*"*20)
largo   = float(input("Ingrese el largo del terreno: "))
ancho = float(input("Ingrese el ancho del terreno: "))

perimetro = 2 * (largo + ancho) #formula del perimetro

print("El perímetro del Terreno es:", perimetro)
...
promedio = (numero1 + numero2 + numero3) / 3   # Se calcula promedio
...
dolares = pesos / 4000  # Suponiendo que 1 dólar = 4000 pesos
